...
class MsgGroupChatvedioTest(TestCase):
    ...
    @tags('ALL', 'SMOKE', 'CMCC', 'group_chat', 'debug_fk', 'high',"CORE")
    ...
    @tags('ALL', 'SMOKE', 'CMCC', 'group_chat', 'debug_fk',"CORE")
    ...
    @tags('ALL', 'SMOKE', 'CMCC', 'group_chat', 'debug_fk1',"CORE")
    ...
    @tags('ALL', 'CMCC', 'message114', 'debug_fk1', 'high',"CORE")
    ...
    @staticmethod
    def setUp_test_msg_xiaoqiu_0414():
