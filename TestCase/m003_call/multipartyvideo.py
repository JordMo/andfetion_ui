...
class CallMultipartyVideo(TestCase):
    ...
    @tags('ALL', 'CMCC_double', 'full', 'full-yyx')
    def test_call_shenlisi_0256(self):
        """检查主叫发起视频通话转语音通话"""
        # 1.用户A点击“切换到语音”按钮
        # 2.用户B查看视频通话界面
        Preconditions.select_mobile('Android-移动-移动')
        ...
        Preconditions.select_mobile('Android-移动')
        time.sleep(3)
        cpg.click_element_("切换到语音")
        Preconditions.select_mobile('Android-移动-移动')
        time.sleep(3)
        cpg.click_element_("语音通话结束按钮")

    @tags('ALL', 'CMCC_double', 'full', 'full-yyx')
    def test_call_shenlisi_0257(self):
        """检查被叫发起视频通话转视语音通话"""
        # 1.用户B点击“切换到语音”按钮
        # 2.用户A查看视频通话界面
        Preconditions.select_mobile('Android-移动-移动')
    ...
    @tags('ALL', 'CMCC_double', 'full', 'full-yyx')
    def test_call_shenlisi_0258(self):
        """检查视频通话--通话界面切换摄像头"""
        # 1.用户A点击“切换摄像头”按钮
        # 2.用户B点击“切换摄像头”按钮
        Preconditions.select_mobile('Android-移动-移动')
    ...
    @tags('ALL', 'CMCC_double', 'full', 'full-yyx')
    def test_call_shenlisi_0260(self):
        """检查视频通话--通话界面静音按钮"""
        # 1.A点击“静音”按钮
        # 2.A对方开始通话
        # 3.用户B听对方的讲话的声音
        ...
        Preconditions.select_mobile('Android-移动')
        time.sleep(3)
        cpg.click_element_("话筒开关按钮")
        time.sleep(3)
        cpg.click_element_("结束双人视频")

    @tags('ALL', 'CMCC_double', 'full', 'full-yyx')
    def test_call_zengxi_0003(self):
        """主叫在语音通话中，消息页支持语音通话入口功能"""
        # 1.在拨号盘输入11位号码，发起语音通话呼叫，被叫接通，然后点击：缩小按钮
        # 2.返回到消息列表页，查看界面显示
        # 3.点击正在通话入口（整个蓝条可以进入）
        # 4.被叫点击挂断，查看主叫界面显示。
        # 5.返回消息列表（作为被叫消息入口显示操作也正常）
        Preconditions.select_mobile('Android-移动-移动')
        phone_number = current_mobile().get_cards(CardType.CHINA_MOBILE)[0]
        Preconditions.change_mobile('Android-移动')
        mess = MessagePage()
        ...
        cpg.click_element_("语音通话接受按钮")
        time.sleep(3)
        cpg.click_element_("语音通话缩放按钮")
        time.sleep(2)
        if not mess.is_on_this_page():
            raise AssertionError("缩放按钮不可用")
        time.sleep(2)
        cpg.click_text("你正在语音通话")
        time.sleep(3)
        cpg.click_element_("语音通话结束按钮")

    @tags('ALL', 'CMCC_double', 'full', 'full-yyx')
    def test_call_zengxi_0007(self):
        """主叫在视频通话中，消息页支持视频通话入口功能"""
        # 1.在单聊会话窗口，发起视频通话呼叫，被叫接通，然后点击：缩小按钮
        # 2.返回到消息列表页，查看界面显示
        # 3.点击正在通话入口（整个蓝条可以进入）
        # 4.被叫点击挂断，查看主叫界面显示。
        # 5.返回消息列表（作为被叫消息入口显示操作也正常）
    ...
    @staticmethod
    def setUp_test_call_zengxi_0011():
        """确保有一个多人的群聊"""
        Preconditions.select_mobile('Android-移动-移动')
        phone_number = current_mobile().get_cards(CardType.CHINA_MOBILE)[0]
        Preconditions.change_mobile('Android-移动')
    ...
    @tags('ALL', 'CMCC_double', 'full', 'full-yyx')
    def test_call_zengxi_0011(self):
        """主叫在多方视频通话中，消息页支持多方视频通话入口功能"""
        # 1.在群聊会话窗口，发起多方视频通话呼叫，被叫接通，然后点击：缩小按钮
        # 2.返回到消息列表页，查看界面显示
        # 3.点击正在通话入口（整个蓝条可以进入）
        # 4.主叫点击挂断，查看主叫界面显示。
        # 5.返回消息列表（作为被叫消息入口显示操作也正常）
    ...
    @tags('ALL', 'CMCC_double', 'full', 'full-yyx')
    def test_call_zengxi_0015(self):
        """主叫在多方电话通话中，消息页支持多方电话通话入口功能"""
        # 1.在通话发起多方电话呼叫，接通系统回呼进入会控界面，被叫接通，然后点击：缩小按钮
        # 2.返回到消息列表页，查看界面显示
        # 3.点击正在通话入口（整个蓝条可以进入）
        # 4.主叫点击挂断，查看主叫界面显示。
        # 5.返回消息列表
    ...
    @staticmethod
    def setUp_test_call_wangqiong_0402():
        """确保有一个多人的群聊"""
        Preconditions.select_mobile('Android-移动-移动')
        phone_number = current_mobile().get_cards(CardType.CHINA_MOBILE)[0]
        Preconditions.change_mobile('Android-移动')
    ...
    @tags('ALL', 'CMCC_double', 'full', 'full-yyx')
    def test_call_wangqiong_0402(self):
        """成功创建会场成功后（12560回呼接通）编辑拒接的、被叫正在通话的、未接听的成员信息"""
        # 1、在和飞信入口（各入口），发起呼叫和飞信，成功创建会场时，进入会控页，点击拒接的、被叫正在通话的、未接听的成员头像
        gcp = GroupChatPage()
        gcp.wait_for_page_load()
        gcp.click_mutilcall()
        time.sleep(2)
    ...
    @staticmethod
    def setUp_test_call_wangqiong_0498():
        """确保有一个多人的群聊"""
        Preconditions.select_mobile('Android-移动-移动')
        phone_number = current_mobile().get_cards(CardType.CHINA_MOBILE)[0]
        Preconditions.change_mobile('Android-移动')
    ...
    @tags('ALL', 'CMCC_double', 'full', 'full-yyx')
    def test_call_wangqiong_0498(self):
        """成功创建会场成功后（12560回呼接通）被叫接通后挂断，通话结束"""
        # 1、在和飞信入口（各入口），发起呼叫和飞信，成功创建会场时，进入会控页，
        # 2.被叫接通后挂断
        gcp = GroupChatPage()
        gcp.wait_for_page_load()
    ...
    @staticmethod
    def setUp_test_call_wangqiong_0403():
        """确保有一个多人的群聊"""
        Preconditions.select_mobile('Android-移动-移动')
        phone_number = current_mobile().get_cards(CardType.CHINA_MOBILE)[0]
        Preconditions.change_mobile('Android-移动')
    ...
    @tags('ALL', 'CMCC_double', 'full', 'full-yyx')
    def test_call_wangqiong_0403(self):
        """成功创建会场成功后（12560回呼接通）编辑已接听的成员信息"""
        # 1、在和飞信入口（各入口），发起呼叫和飞信，成功创建会场时，进入会控页，点击已接听的成员头像
        gcp = GroupChatPage()
        gcp.wait_for_page_load()
        gcp.click_mutilcall()
        time.sleep(2)
    ...
    @staticmethod
    def setUp_test_call_wangqiong_0218_01():
        """确保有一个多人的群聊"""
        Preconditions.select_mobile('Android-移动-移动')
        phone_number = current_mobile().get_cards(CardType.CHINA_MOBILE)[0]
        Preconditions.change_mobile('Android-移动')
    ...
    @tags('ALL', 'CMCC_double', 'full', 'full-yyx')
    def test_call_wangqiong_0218_01(self):
    ...
    @staticmethod
    def setUp_test_call_wangqiong_0220():
        """确保有一个多人的群聊"""
        Preconditions.select_mobile('Android-移动-移动')
        phone_number = current_mobile().get_cards(CardType.CHINA_MOBILE)[0]
        Preconditions.change_mobile('Android-移动')
    ...
    @tags('ALL', 'CMCC_double', 'full', 'full-yyx')
    def test_call_wangqiong_0220(self):
        """多方电话被叫接通时--点击缩小按钮，缩小悬浮显示正常"""
        # 1.点击会控界面中的缩小按钮
        # 2.点击悬浮，长按任一移动
        group_name = Preconditions.get_group_chat_name_double()
        Preconditions.change_mobile('Android-移动-移动')
    ...
    @staticmethod
    def setUp_test_call_wangqiong_0223():
        """确保有一个多人的群聊"""
        Preconditions.select_mobile('Android-移动-移动')
        phone_number = current_mobile().get_cards(CardType.CHINA_MOBILE)[0]
        Preconditions.change_mobile('Android-移动')
    ...
    @tags('ALL', 'CMCC_double', 'full', 'full-yyx')
    def test_call_wangqiong_0223(self):
        """多方电话被叫接通时--网络正常下，会控点击+，可跳转到联系人选择器正常"""
        # 1.点击 +
        # 2.点击呼叫
        # 3.选中CD2个联系人，查看显示
        # 4.点击呼叫（2 / 6）
        ...
        gcp.click_text("最多9人")
        time.sleep(3)
        if not gcp.is_element_exit_("搜索成员输入框"):
            raise AssertionError("不能跳转到联系人选择器")
        time.sleep(2)
        Preconditions.select_mobile('Android-移动')
        gcp.hang_up_the_call()

    @staticmethod
    def setUp_test_call_wangqiong_0231():
        """确保有一个多人的群聊"""
        Preconditions.select_mobile('Android-移动-移动')
        phone_number = current_mobile().get_cards(CardType.CHINA_MOBILE)[0]
        Preconditions.change_mobile('Android-移动')
    ...
    @tags('ALL', 'CMCC_double', 'full', 'full-yyx')
    def test_call_wangqiong_0231(self):
        """会控界面+，邀请规则遵循“最多9人通话”规则"""
        # 1.点击 +
        # 2.依次选中6个联系人，查看呼叫显示
        # 3.点击呼叫
        # 4.移除一个已挂断的被叫
    ...
    @staticmethod
    def setUp_test_call_wangqiong_0232():
        """确保有一个多人的群聊"""
        Preconditions.select_mobile('Android-移动-移动')
        phone_number = current_mobile().get_cards(CardType.CHINA_MOBILE)[0]
        Preconditions.change_mobile('Android-移动')
    ...
    @tags('ALL', 'CMCC_double', 'full', 'full-yyx')
    def test_call_wangqiong_0232(self):
        """会控界面+，邀请人数上限时弹出提醒"""
        # 1.点击 +
        # 2.依次选中6个联系人，查看呼叫显示
        # 3.再选中1人（搜索匹配结果再点击，结果也一样）
        group_name = Preconditions.get_group_chat_name_double()
        Preconditions.change_mobile('Android-移动-移动')
        Preconditions.go_to_group_double(group_name)
        gcp = GroupChatPage()
    ...
    @staticmethod
    def setUp_test_call_wangqiong_0234():
        """确保有一个多人的群聊"""
        Preconditions.select_mobile('Android-移动-移动')
        phone_number = current_mobile().get_cards(CardType.CHINA_MOBILE)[0]
        Preconditions.change_mobile('Android-移动')
    ...
    @tags('ALL', 'CMCC_double', 'full', 'full-yyx')
    def test_call_wangqiong_0234(self):
        """多方电话管理页面新增“全员禁言”按钮"""
        # 检查多方电话管理页面
        group_name = Preconditions.get_group_chat_name_double()
        Preconditions.change_mobile('Android-移动-移动')
        ...
        if gcp.is_text_present("现在去开启"):
            gcp.click_text("暂不开启")
        time.sleep(3)
        if not gcp.is_element_exit_("飞信电话会控全员禁音"):
            raise AssertionError("没有全员禁音按钮")
        time.sleep(3)
        gcp.click_element_("挂断和飞信电话")
        time.sleep(2)
        gcp.click_element_("确定移除")
        Preconditions.select_mobile('Android-移动')
        gcp.hang_up_the_call()
    ...
    @staticmethod
    def setUp_test_call_wangqiong_0238():
        """确保有一个多人的群聊"""
        Preconditions.select_mobile('Android-移动-移动')
        phone_number = current_mobile().get_cards(CardType.CHINA_MOBILE)[0]
        Preconditions.change_mobile('Android-移动')
    ...
    @tags('ALL', 'CMCC_double', 'full', 'full-yyx')
    def test_call_wangqiong_0238(self):
        """主叫发起多方电话，被叫有接通以及未接的，主叫点击“全员禁言”，检查已接通的被叫状态"""
        # 1.主叫发起多方电话，被叫有接通以及未接的
        # 2.主叫在多方电话管理页面点击“全员禁言”按钮
        # 3.检查已接通的被叫状态
        group_name = Preconditions.get_group_chat_name_double()
        Preconditions.change_mobile('Android-移动-移动')
        Preconditions.go_to_group_double(group_name)
    ...
    @staticmethod
    def setUp_test_call_wangqiong_0260():
        """确保有一个多人的群聊"""
        Preconditions.select_mobile('Android-移动-移动')
        phone_number = current_mobile().get_cards(CardType.CHINA_MOBILE)[0]
        Preconditions.change_mobile('Android-移动')
    ...
    @tags('ALL', 'CMCC_double', 'full', 'full-yyx')
    def test_call_wangqiong_0260(self):
        """会控界面：对“接通中”状态的成员，可点击头像，可移除成员、可取消成功，可禁言"""
        # 1.点击已接通的被叫头像
        # 2.点击编辑操作（禁言 / 移除 / 取消）
        gcp = GroupChatPage()
        gcp.wait_for_page_load()
    ...
    @staticmethod
    def setUp_test_call_wangqiong_0261():
        """确保有一个多人的群聊"""
        Preconditions.select_mobile('Android-移动-移动')
        phone_number = current_mobile().get_cards(CardType.CHINA_MOBILE)[0]
        Preconditions.change_mobile('Android-移动')
    ...
    @tags('ALL', 'CMCC_double', 'full', 'full-yyx')
    def test_call_wangqiong_0261(self):
        """会控界面：对“已挂断”成员，点击头像，可支持重新呼叫、移除成员、取消成功"""
        # 1.点击“已挂断”的被叫头像
        # 2.点击编辑操作（重新呼叫 / 移除 / 取消）
        gcp = GroupChatPage()
        gcp.wait_for_page_load()
