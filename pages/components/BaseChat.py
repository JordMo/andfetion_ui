...
class BaseChatPage(BasePage):
    ...
    __locators = {'': (MobileBy.ID, ''),
                  'com.cmic.junyuntong:id/iv_bkg': (MobileBy.ID, 'com.cmic.junyuntong:id/iv_bkg'),
                  'com.cmic.junyuntong:id/input_and_menu': (MobileBy.ID, 'com.cmic.junyuntong:id/input_and_menu'),
                  'com.cmic.junyuntong:id/ll_text_input': (MobileBy.ID, 'com.cmic.junyuntong:id/ll_text_input'),
                  'com.cmic.junyuntong:id/layout_for_message': (MobileBy.ID, 'com.cmic.junyuntong:id/layout_for_message'),
                  'com.cmic.junyuntong:id/ll_rich_panel': (MobileBy.ID, 'com.cmic.junyuntong:id/ll_rich_panel'),
                  '选择图片': (MobileBy.ID, 'com.cmic.junyuntong:id/ib_pic'),
                  '选择相机': (MobileBy.ID, 'com.cmic.junyuntong:id/ib_take_photo'),
                  '选择名片': (MobileBy.ID, 'com.cmic.junyuntong:id/ib_profile'),
                  '选择gif': (MobileBy.ID, 'com.cmic.junyuntong:id/rel_gif'),
                  '选择更多': (MobileBy.ID, 'com.cmic.junyuntong:id/ib_more'),
                  'com.cmic.junyuntong:id/input_divider_inside': (
                      MobileBy.ID, 'com.cmic.junyuntong:id/input_divider_inside'),
                  'com.cmic.junyuntong:id/input_layout': (MobileBy.ID, 'com.cmic.junyuntong:id/input_layout'),
                  'com.cmic.junyuntong:id/fl_edit_panel': (MobileBy.ID, 'com.cmic.junyuntong:id/fl_edit_panel'),
                  '说点什么...': (MobileBy.ID, 'com.cmic.junyuntong:id/et_message'),
                  'com.cmic.junyuntong:id/ib_expression': (MobileBy.ID, 'com.cmic.junyuntong:id/ib_expression'),
                  '语音按钮': (MobileBy.ID, 'com.cmic.junyuntong:id/ib_audio'),
                  '发送按钮': (MobileBy.ID, 'com.cmic.junyuntong:id/ib_send'),
                  'com.cmic.junyuntong:id/ib_record_red_dot': (MobileBy.ID, 'com.cmic.junyuntong:id/ib_record_red_dot'),
                  # 消息长按弹窗
